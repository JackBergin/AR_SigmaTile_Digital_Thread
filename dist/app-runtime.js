...
(function () {
  ...
  twx.app.fn.getThreeStateBoolInv = function (value) {
  ...
  twx.app.fn.hideAll3DWidgets = function () {
    ...
    all3DElements.forEach(function (element) {
      ...
      if (originalWidgetScope) {
        originalWidgetScope.me.initForceHidden = originalWidgetScope.me.forceHidden;
        originalWidgetScope.me.initVisible = originalWidgetScope.me.visible;
