      ...
      <div class="twx-picture-service-layer">
        ...
        <div class="camera-confirmation-overlay" ng-show="confirmationShown">
          ...
          <div class="button-overlay">
            <div>
              <button class="--reject" ng-click="rejectImage()" data-wml-speech-command="{{me.cancelLabel}}" title="hf_use_description|{{me.cancelLabel}}"
               onmouseover="this.setAttribute('data-title', this.title); this.title = this.title.replace('hf_use_description|', '')" onmouseout="this.setAttribute('title', this.getAttribute('data-title')">
                {{me.cancelLabel}}
              </button>
              <button class="--retake" ng-click="retakeImage()" data-wml-speech-command="{{me.retakeLabel}}" title="hf_use_description|{{me.retakeLabel}}"
               onmouseover="this.setAttribute('data-title', this.title); this.title = this.title.replace('hf_use_description|', '')" onmouseout="this.setAttribute('title', this.getAttribute('data-title')">
                {{me.retakeLabel}}
              </button>
              <button class="--accept" ng-click="acceptImage()" data-wml-speech-command="{{me.acceptLabel}}" title="hf_use_description|{{me.acceptLabel}}"
               onmouseover="this.setAttribute('data-title', this.title); this.title = this.title.replace('hf_use_description|', '')" onmouseout="this.setAttribute('title', this.getAttribute('data-title')">
                {{me.acceptLabel}}
              </button>
            </div>
